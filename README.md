This is a sand drop simulator using celullar automata. The sand is represented by a 2D grid of cells, and the simulation is done by updating the grid in discrete time steps.
